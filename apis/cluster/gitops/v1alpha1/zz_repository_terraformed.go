...
func (mg *Repository) GetTerraformResourceType() string {
	return "harness_platform_gitops_repository"
}

// GetConnectionDetailsMapping for this Repository
func (tr *Repository) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"ecr_gen[*].secret_ref[*].aws_secret_access_key": "ecrGen[*].secretRef[*].awsSecretAccessKeySecretRef", "ecr_gen[*].secret_ref[*].aws_session_token": "ecrGen[*].secretRef[*].awsSessionTokenSecretRef", "gcr_gen[*].access_key": "gcrGen[*].accessKeySecretRef", "repo[*].github_app_id": "repo[*].githubAppIdSecretRef", "repo[*].github_app_installation_id": "repo[*].githubAppInstallationIdSecretRef", "repo[*].github_app_private_key": "repo[*].githubAppPrivateKeySecretRef", "repo[*].password": "repo[*].passwordSecretRef", "repo[*].ssh_private_key": "repo[*].sshPrivateKeySecretRef", "repo[*].tls_client_cert_data": "repo[*].tlsClientCertDataSecretRef", "repo[*].tls_client_cert_key": "repo[*].tlsClientCertKeySecretRef"}
}
