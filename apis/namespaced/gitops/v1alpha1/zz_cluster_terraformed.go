...
func (mg *Cluster) GetTerraformResourceType() string {
	return "harness_platform_gitops_cluster"
}

// GetConnectionDetailsMapping for this Cluster
func (tr *Cluster) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"request[*].cluster[*].config[*].bearer_token": "request[*].cluster[*].config[*].bearerTokenSecretRef", "request[*].cluster[*].config[*].password": "request[*].cluster[*].config[*].passwordSecretRef", "request[*].cluster[*].config[*].tls_client_config[*].cert_data": "request[*].cluster[*].config[*].tlsClientConfig[*].certDataSecretRef", "request[*].cluster[*].config[*].tls_client_config[*].key_data": "request[*].cluster[*].config[*].tlsClientConfig[*].keyDataSecretRef"}
}
