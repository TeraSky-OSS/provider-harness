...
func (mg *SshKey) GetTerraformResourceType() string {
	return "harness_platform_secret_sshkey"
}

// GetConnectionDetailsMapping for this SshKey
func (tr *SshKey) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"kerberos[*].tgt_password_spec[*].password": "kerberos[*].tgtPasswordSpec[*].passwordSecretRef", "ssh[*].ssh_password_credential[*].password": "ssh[*].sshPasswordCredential[*].passwordSecretRef", "ssh[*].sshkey_path_credential[*].encrypted_passphrase": "ssh[*].sshkeyPathCredential[*].encryptedPassphraseSecretRef", "ssh[*].sshkey_reference_credential[*].encrypted_passphrase": "ssh[*].sshkeyReferenceCredential[*].encryptedPassphraseSecretRef"}
}
