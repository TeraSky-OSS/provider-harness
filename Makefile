...
export TERRAFORM_PROVIDER_SOURCE ?= harness/harness
export TERRAFORM_PROVIDER_REPO ?= https://github.com/harness/terraform-provider-harness
export TERRAFORM_PROVIDER_VERSION ?= 0.42.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-harness
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/harness/terraform-provider-harness/releases/download/v${TERRAFORM_PROVIDER_VERSION}/
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-harness_v${TERRAFORM_PROVIDER_VERSION}
